...
namespace TameVisualStudioTooltips3
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class TameQuickInfoCommand2
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TameQuickInfoCommand2"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        /// <param name="commandService">Command service to add command to, not null.</param>
        private TameQuickInfoCommand2( AsyncPackage package, OleMenuCommandService commandService )
        {
            this.package = package ?? throw new ArgumentNullException( nameof( package ) );
            commandService = commandService ?? throw new ArgumentNullException( nameof( commandService ) );

            File.AppendAllText( @"d:\temp\dump", "TameQuickInfoCommand2: " + DateTime.Now.ToString() + "\r\n" );
        ...
        /// </summary>
        public static TameQuickInfoCommand2 Instance
        {
            get;
            private set;
        }
        ...
        public static async Task InitializeAsync( AsyncPackage package )
        {
            ...
            Instance = new TameQuickInfoCommand2( package, commandService );
        }
